...
public class BiomeReplacementProcessor extends StructureProcessor implements FormationsStructureProcessor {
    ...
    static{
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_PLANKS, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_PLANKS, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_STAIRS, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_STAIRS, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_SLAB, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_SLAB, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_BLOCK, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_LOG, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_BLOCK, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_WOOD, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.STRIPPED_BAMBOO_BLOCK, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.STRIPPED_CHERRY_LOG, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.STRIPPED_BAMBOO_BLOCK, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.STRIPPED_CHERRY_WOOD, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.CHERRY_LEAVES, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_DOOR, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_DOOR, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_TRAPDOOR, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_TRAPDOOR, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_SIGN, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_SIGN, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_WALL_SIGN, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_WALL_SIGN, List.of(Biomes.CHERRY_GROVE)),
        ...
        // Hanging signs
        addReplacements(
            Pair.of(Blocks.OAK_HANGING_SIGN, List.of(Biomes.PLAINS, Biomes.SUNFLOWER_PLAINS, Biomes.FOREST, Biomes.FLOWER_FOREST, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS, Biomes.WINDSWEPT_FOREST, Biomes.WOODED_BADLANDS, Biomes.MEADOW, Biomes.BEACH, Biomes.STONY_SHORE, Biomes.DRIPSTONE_CAVES, Biomes.DEEP_DARK)),
            Pair.of(Blocks.SPRUCE_HANGING_SIGN, List.of(Biomes.SNOWY_PLAINS, Biomes.ICE_SPIKES, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.TAIGA, Biomes.SNOWY_TAIGA, Biomes.GROVE, Biomes.SNOWY_SLOPES, Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS, Biomes.STONY_PEAKS, Biomes.FROZEN_RIVER, Biomes.SNOWY_BEACH, Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN)),
            Pair.of(Blocks.MANGROVE_HANGING_SIGN, List.of(Biomes.SWAMP, Biomes.MANGROVE_SWAMP)),
            Pair.of(Blocks.BIRCH_HANGING_SIGN, List.of(Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.RIVER)),
            Pair.of(Blocks.DARK_OAK_HANGING_SIGN, List.of(Biomes.DARK_FOREST, Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN, Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN)),
            Pair.of(Blocks.ACACIA_HANGING_SIGN, List.of(Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU, Biomes.WINDSWEPT_SAVANNA, Biomes.BADLANDS, Biomes.ERODED_BADLANDS, Biomes.DESERT)),
            Pair.of(Blocks.JUNGLE_HANGING_SIGN, List.of(Biomes.JUNGLE, Biomes.SPARSE_JUNGLE, Biomes.LUSH_CAVES)),
            Pair.of(Blocks.BAMBOO_HANGING_SIGN, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_HANGING_SIGN, List.of(Biomes.CHERRY_GROVE)),
            Pair.of(Blocks.CRIMSON_HANGING_SIGN, List.of(Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST)),
            Pair.of(Blocks.WARPED_HANGING_SIGN, List.of(Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY, Biomes.BASALT_DELTAS, Biomes.THE_END, Biomes.END_HIGHLANDS, Biomes.END_MIDLANDS, Biomes.SMALL_END_ISLANDS, Biomes.END_BARRENS))
        );
        // Hanging wall signs
        addReplacements(
            Pair.of(Blocks.OAK_WALL_HANGING_SIGN, List.of(Biomes.PLAINS, Biomes.SUNFLOWER_PLAINS, Biomes.FOREST, Biomes.FLOWER_FOREST, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS, Biomes.WINDSWEPT_FOREST, Biomes.WOODED_BADLANDS, Biomes.MEADOW, Biomes.BEACH, Biomes.STONY_SHORE, Biomes.DRIPSTONE_CAVES, Biomes.DEEP_DARK)),
            Pair.of(Blocks.SPRUCE_WALL_HANGING_SIGN, List.of(Biomes.SNOWY_PLAINS, Biomes.ICE_SPIKES, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.TAIGA, Biomes.SNOWY_TAIGA, Biomes.GROVE, Biomes.SNOWY_SLOPES, Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS, Biomes.STONY_PEAKS, Biomes.FROZEN_RIVER, Biomes.SNOWY_BEACH, Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN)),
            Pair.of(Blocks.MANGROVE_WALL_HANGING_SIGN, List.of(Biomes.SWAMP, Biomes.MANGROVE_SWAMP)),
            Pair.of(Blocks.BIRCH_WALL_HANGING_SIGN, List.of(Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.RIVER)),
            Pair.of(Blocks.DARK_OAK_WALL_HANGING_SIGN, List.of(Biomes.DARK_FOREST, Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN, Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN)),
            Pair.of(Blocks.ACACIA_WALL_HANGING_SIGN, List.of(Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU, Biomes.WINDSWEPT_SAVANNA, Biomes.BADLANDS, Biomes.ERODED_BADLANDS, Biomes.DESERT)),
            Pair.of(Blocks.JUNGLE_WALL_HANGING_SIGN, List.of(Biomes.JUNGLE, Biomes.SPARSE_JUNGLE, Biomes.LUSH_CAVES)),
            Pair.of(Blocks.BAMBOO_WALL_HANGING_SIGN, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_WALL_HANGING_SIGN, List.of(Biomes.CHERRY_GROVE)),
            Pair.of(Blocks.CRIMSON_WALL_HANGING_SIGN, List.of(Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST)),
            Pair.of(Blocks.WARPED_WALL_HANGING_SIGN, List.of(Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY, Biomes.BASALT_DELTAS, Biomes.THE_END, Biomes.END_HIGHLANDS, Biomes.END_MIDLANDS, Biomes.SMALL_END_ISLANDS, Biomes.END_BARRENS))
        );
        // Fences
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_FENCE, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_FENCE, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_FENCE_GATE, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_FENCE_GATE, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_PRESSURE_PLATE, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_PRESSURE_PLATE, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.BAMBOO_BUTTON, List.of(Biomes.BAMBOO_JUNGLE)),
            Pair.of(Blocks.CHERRY_BUTTON, List.of(Biomes.CHERRY_GROVE)),
        ...
        addReplacements(
            ...
            Pair.of(Blocks.CHERRY_SAPLING, List.of(Biomes.CHERRY_GROVE)),
        ...
        // Chiseled bricks
        addReplacements(
            Pair.of(Blocks.CHISELED_STONE_BRICKS, List.of(Biomes.PLAINS, Biomes.SUNFLOWER_PLAINS, Biomes.FOREST, Biomes.FLOWER_FOREST, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS, Biomes.WINDSWEPT_FOREST, Biomes.MEADOW, Biomes.BEACH, Biomes.STONY_SHORE, Biomes.DRIPSTONE_CAVES, Biomes.SNOWY_PLAINS, Biomes.ICE_SPIKES, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.TAIGA, Biomes.SNOWY_TAIGA, Biomes.GROVE, Biomes.SNOWY_SLOPES, Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS, Biomes.STONY_PEAKS, Biomes.FROZEN_RIVER, Biomes.SNOWY_BEACH, Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN, Biomes.SWAMP, Biomes.MANGROVE_SWAMP, Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.RIVER, Biomes.DARK_FOREST, Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN, Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN, Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU, Biomes.WINDSWEPT_SAVANNA, Biomes.JUNGLE, Biomes.SPARSE_JUNGLE, Biomes.LUSH_CAVES, Biomes.BAMBOO_JUNGLE, Biomes.CHERRY_GROVE)),
        ...
        // Dirt
        addReplacements(
            Pair.of(Blocks.DIRT, List.of(Biomes.PLAINS, Biomes.SUNFLOWER_PLAINS, Biomes.FOREST, Biomes.FLOWER_FOREST, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS, Biomes.WINDSWEPT_FOREST, Biomes.MEADOW, Biomes.BEACH, Biomes.STONY_SHORE, Biomes.DRIPSTONE_CAVES, Biomes.SNOWY_PLAINS, Biomes.ICE_SPIKES, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.TAIGA, Biomes.SNOWY_TAIGA, Biomes.GROVE, Biomes.SNOWY_SLOPES, Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS, Biomes.STONY_PEAKS, Biomes.FROZEN_RIVER, Biomes.SNOWY_BEACH, Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN, Biomes.SWAMP, Biomes.MANGROVE_SWAMP, Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.RIVER, Biomes.DARK_FOREST, Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN, Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN, Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU, Biomes.WINDSWEPT_SAVANNA, Biomes.JUNGLE, Biomes.SPARSE_JUNGLE, Biomes.LUSH_CAVES, Biomes.BAMBOO_JUNGLE, Biomes.CHERRY_GROVE, Biomes.DEEP_DARK)),
            Pair.of(Blocks.SAND, List.of(Biomes.DESERT)),
        ...
        // Stone
        addReplacements(
            Pair.of(Blocks.STONE, List.of(Biomes.PLAINS, Biomes.SUNFLOWER_PLAINS, Biomes.FOREST, Biomes.FLOWER_FOREST, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS, Biomes.WINDSWEPT_FOREST, Biomes.MEADOW, Biomes.BEACH, Biomes.STONY_SHORE, Biomes.DRIPSTONE_CAVES, Biomes.SNOWY_PLAINS, Biomes.ICE_SPIKES, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.TAIGA, Biomes.SNOWY_TAIGA, Biomes.GROVE, Biomes.SNOWY_SLOPES, Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS, Biomes.STONY_PEAKS, Biomes.FROZEN_RIVER, Biomes.SNOWY_BEACH, Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN, Biomes.SWAMP, Biomes.MANGROVE_SWAMP, Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.RIVER, Biomes.DARK_FOREST, Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN, Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN, Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU, Biomes.WINDSWEPT_SAVANNA, Biomes.JUNGLE, Biomes.SPARSE_JUNGLE, Biomes.LUSH_CAVES, Biomes.BAMBOO_JUNGLE, Biomes.CHERRY_GROVE, Biomes.DEEP_DARK, Biomes.DESERT)),
            Pair.of(Blocks.TERRACOTTA, List.of(Biomes.BADLANDS, Biomes.ERODED_BADLANDS, Biomes.WOODED_BADLANDS)),
            Pair.of(Blocks.BASALT, List.of(Biomes.BASALT_DELTAS)),
