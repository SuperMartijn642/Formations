...
public class FormationsStructures {
    ...
    public static final RegistryObject<MapCodec<BedColorProcessor>> BED_COLOR_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("random_bed_color", () -> BedColorProcessor.CODEC);
    public static final RegistryObject<MapCodec<BiomeReplacementProcessor>> BIOME_REPLACEMENT_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("biome_replacements", () -> BiomeReplacementProcessor.CODEC);
    public static final RegistryObject<MapCodec<BrewingStandProcessor>> BREWING_STAND_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("fill_brewing_stands", () -> BrewingStandProcessor.CODEC);
    public static final RegistryObject<MapCodec<ChiseledBookshelfProcessor>> CHISELED_BOOKSHELF_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("fill_chiseled_bookshelves", () -> ChiseledBookshelfProcessor.CODEC);
    public static final RegistryObject<MapCodec<FormationsBlockAgeProcessor>> BLOCK_AGE_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("block_age", () -> FormationsBlockAgeProcessor.CODEC);
    public static final RegistryObject<MapCodec<PlantGrowthProcessor>> PLANT_GROWTH_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("random_plant_growth", () -> PlantGrowthProcessor.CODEC);
    public static final RegistryObject<MapCodec<RespawnAnchorProcessor>> RESPAWN_ANCHOR_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("respawn_anchor_charges", () -> RespawnAnchorProcessor.CODEC);
    public static final RegistryObject<MapCodec<WaterloggingProcessor>> WATERLOGGING_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("waterlogging", () -> WaterloggingProcessor.CODEC);
