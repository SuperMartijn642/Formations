...
public class FormationsStructures {
    ...
    // Structures
    private static final DeferredRegister<StructureType<?>> STRUCTURE_TYPES = DeferredRegister.create(Registry.STRUCTURE_TYPE_REGISTRY, Formations.MODID);
    ...
    // Pool elements
    private static final DeferredRegister<StructurePoolElementType<?>> STRUCTURE_POOL_ELEMENTS = DeferredRegister.create(Registry.STRUCTURE_POOL_ELEMENT_REGISTRY, Formations.MODID);
    ...
    // Processors
    private static final DeferredRegister<StructureProcessorType<?>> STRUCTURE_PROCESSOR_TYPES = DeferredRegister.create(Registry.STRUCTURE_PROCESSOR_REGISTRY, Formations.MODID);
